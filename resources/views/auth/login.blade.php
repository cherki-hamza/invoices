							...
							<div class="row">
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										<div class="mb-5 d-flex"> <a href="{{ url('/' . $page='Home') }}"><img src="{{URL::asset('public/assets/img/brand/favicon.png')}}" class="sign-favicon ht-40" alt="cherki hamza"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Cherki <span> Ha</span>mza</h1></div>
										<div class="card-sigin">
