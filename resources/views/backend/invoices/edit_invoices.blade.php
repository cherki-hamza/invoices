...
@endsection
@section('title')
{{__('dashboard.edit')}} {{__('dashboard.invoices')}} 
@stop
                    ...
                    <form action="{{ route('invoices.update' , $invoice->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="due_date" value="{{$invoice->due_date}}" placeholder="YYYY-MM-DD"
                                    type="text" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="amount_commission"
                                    name="amount_commission" title="يرجي ادخال مبلغ العمولة "  value="{{$invoice->amount_commission}}"required>
                            </div>
