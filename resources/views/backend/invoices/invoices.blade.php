...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('dashboard.invoices') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.billing_list') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                        ...
                                        <table id="example" class="table key-buttons text-md-nowrap">
                                            <thead>
                                                <tr class="bg-info">
                                                    ...
                                                    <th class="border-bottom-0"> {{ __('dashboard.invoice') }} </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu tx-13">
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        ...
                                                                        {{__('dashboard.edit')}} {{__('dashboard.invoice')}}</a>
                                                                
            
                                                                
                                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                        data-toggle="modal" data-target="#delete_invoice"><i
                                                                            class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp;{{__('dashboard.delete')}} {{__('dashboard.invoice')}}
                                                                        </a>
                                                                    ...
                                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                        data-toggle="modal" data-target="#transfer_invoice"><i
                                                                            class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp; {{__('dashboard.archived')}}</a>
                                                               
            
                                                               
                                                                    <a class="dropdown-item" href="{{ route('print_invoice',$invoice->id) }}"><i
                                                                            class="text-success fas fa-print"></i>&nbsp;&nbsp; {{__('dashboard.invoice_printing')}}
                                                                    </a>
                    ...
                    <div class="modal fade" id="transfer_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{__('dashboard.are_you_sure_to_archiving_process')}}
                                    <input type="hidden" name="invoice_id" id="invoice_id" value="">
                                    <input type="hidden" name="id_page" id="id_page" value="archived">
