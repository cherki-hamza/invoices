				...
				<div class="container-fluid">
					<div class="main-header-left">
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('public/assets/img/brand/ch/logo.png')}}" class="logo-1" alt="ch"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('public/assets/img/brand/ch/logo.png')}}" class="dark-logo-1" alt="ch"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('public/assets/img/brand/ch/logo.png')}}" class="logo-2" alt="ch"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('public/assets/img/brand/ch/logo.png')}}" class="dark-logo-2" alt="ch"></a>
						</div>
								...
								<div class="dropdown  nav-itemd-none d-md-flex">
                                    @if(LaravelLocalization::getCurrentLocale() ==='ar')
                                      ...
                                      <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent">🇸🇦</span>
										<div class="my-auto">
